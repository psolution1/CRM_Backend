...
const {
  LeadProductServiceOverviewApi,
} = require("../controllers/allReportController");
...
router
  .route("/LeadSourceOverviewApiForTeamLeader")
  .post(LeadSourceOverviewApiForTeamLeader); //for Admin
router
  .route("/LeadSourceOverviewApiForUser")
  .post(LeadSourceOverviewApiForUser); //for Admin

router.route("/Income_Graph_Overview").get(IncomeGraphOverview); ////for admin
router
  .route("/IncomeGraphOverviewForTeamLeader")
  .post(IncomeGraphOverviewForTeamLeader); ////for tl
...
router
  .route("/LeadProductServiceOverviewApi")
  .get(LeadProductServiceOverviewApi);
...
router
  .route("/DashboardLeadCountOfUserByTeamLeader")
  .post(DashboardLeadCountOfUserByTeamLeader);
