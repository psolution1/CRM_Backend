...
const {
  addandupdatetransactionalsms,
  getallsmsrecord,
  getallwhatsmsrecord,
  addandupdatewhatappsms,
} = require("../controllers/transactionalsmsController");
const router = express.Router();
router
  .route("/addandupdatetransactionalsms")
  .post(addandupdatetransactionalsms);
